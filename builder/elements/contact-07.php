...
<!-- / Contact section -->
<section class="contact-section contact-section-2 dark pos-rel">
	<div class="container pos-rel z2">
		<div class="row">
			<div class="col-md-5 r">
				<div class="content">
					<h2 class="title">Contact us</h2>
					<p class="title-sub small" style="color: #fff;">Lorem ipsum dolor sit amet, consetetur sadipscing elitr<br>
					...
					<div class="info-box info-box5">
						...
						<div class="info">
							...
							<p class="sub-txt" style="color: #fff;">PO Box 16122, Collins Street West, Victoria 8007, Australia</p>
						</div>
					</div><!-- Address -->
					...
					<div class="info-box info-box5">
						...
						<div class="info">
							...
							<p class="sub-txt" style="color: #fff;">1-123-456-7890</p>
						</div>
					</div><!-- Call us -->
					...
					<div class="info-box info-box5">
						...
						<div class="info">
							...
							<p class="sub-txt" style="color: #fff;"><a href="mailto:abc@xyz.com">abc@xyz.com</a></p>
						</div>
					</div><!-- Email us -->	
				</div><!-- /.content -->
			</div><!-- /.col-md-6 -->
	...
	<div class="overlay full-wh bg-cover bg-cc" data-bg="images/bg19.jpg"><b class="full-wh overlay" style="background-color: rgba(49, 90, 39, 0.5);"></b></div>
