...
<section class="other-section other-section-2">
	<div class="container">
		...
		<ul class="tab-widget">
			<li><a href="#" data-tb="#step1" class="active"><i>1</i></a></li>
			<li><hr></li>
			<li><a href="#" data-tb="#step2"><i>2</i></a></li>
			<li><hr></li>
			<li><a href="#" data-tb="#step3"><i>3</i></a></li>
		</ul>
