...
<section class="other-section other-section-2 dark">
	<div class="container">
		...
		<ul class="tab-widget icon-tab">
			<li><a href="#" data-tb="#step3-1" class="active"><i class="icon-mobile"></i></a></li>
			<li><hr></li>
			<li><a href="#" data-tb="#step3-2"><i class="icon-laptop"></i></a></li>
			<li><hr></li>
			<li><a href="#" data-tb="#step3-3"><i class="icon-desktop"></i></a></li>
		</ul>
