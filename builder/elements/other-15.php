...
<!-- Other section -->
<section class="other-section other-section-7 bg-cover bg-cc" data-bg="images/bg5.jpg">
	<div class="full-wh w-50 map r">
		...
		<div class="row eqh">
			<div class="col-md-6">
				<div class="content">
					...
					<h2 class="title">Everyday<br>9am to 10pm</h2>
